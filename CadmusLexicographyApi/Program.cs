...
using Cadmus.Lexicography.Services;

namespace CadmusLexicographyApi;
...
public static class Program
{
        ...
        IConfiguration config)
    {
        ...
        services.AddSingleton<IRepositoryProvider>(
            _ => new LexicographyRepositoryProvider { ConnectionString = dataCS });

        // part seeder factory provider
        services.AddSingleton<IPartSeederFactoryProvider,
            LexicographyPartSeederFactoryProvider>();
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                options.WithTitle("Cadmus Lexicography API")
